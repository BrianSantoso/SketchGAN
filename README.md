...
The generator's output after around 79.5k training iterations appears to have the most distinct figures. As the network approaches 100k iterations, the figures become more intricate but seem to resemble 'doodles' more than sketches.
